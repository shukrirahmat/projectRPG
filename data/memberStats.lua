...
memberStats[1] = {
    ...
    vit = 7,
    agi = 7,
    skills = {'auraI', 'auraII', 'auraIII', 'auraCharge', 'drainI', 'drainII'},
    passiveSkills = {'dualWielder', 'leechLord'},
    status = {},
    totalExp = 0,
}
...
memberStats[2] = {
    ...
    vit = 6,
    agi = 8,
    skills = {'auraBlastI', 'auraBlastII', 'auraCharge', 'drakebaneI', 'drakebaneII'},
