...
font_text = love.graphics.newFont('fonts/AtkinsonHyperlegibleMono-Medium.ttf', 18)
font_large = love.graphics.newFont('fonts/AtkinsonHyperlegibleMono-Medium.ttf', 18)
font_xlarge = love.graphics.newFont('fonts/AtkinsonHyperlegibleMono-Medium.ttf', 20)
